...
export template<typename T, typename = std::enable_if_t<std::is_arithmetic_v<T>>>
constexpr double normalize(T value, T in_min, T in_max, 
...
// Set random seed
export void set_random_seed(unsigned int seed) {
...
export std::vector<int> range(int end) {
...
// Degrees to radians
export constexpr double deg_to_rad(double degrees) {
    return degrees * PI / 180.0;
}

// Radians to degrees
export constexpr double rad_to_deg(double radians) {
