...
// Replace using regex
export expected<std::string, error_info>
regex_replace(std::string_view str, const std::string& pattern, std::string_view replacement) {
  try {
    std::regex re(pattern);
...
export expected<std::vector<std::string>, error_info> regex_find_all(std::string_view str,
